...
* Signal Divider - Fast (2441, 8, 84)

#+BEGIN_EXPORT html
<section class="accordion">
  <input type="checkbox" name="collapse" id="handle_signal_divider_fast_1">
  <h2 class="handle">
    <label for="handle_signal_divider_fast_1">Scoreboard</label>
  </h2>
  <div class="content">
    <a href="/media/images/signal_divider_doubled_division_parallel_scoreboard.jpg" target="_blank">
      <img style="height: 100%" src="/media/images/signal_divider_doubled_division_parallel_scoreboard.jpg" />
    </a>
  </div>
</section>
<section class="accordion">
  <input type="checkbox" name="collapse" id="handle_signal_divider_fast_2">
  <h2 class="handle">
    <label for="handle_signal_divider_fast_2">Code</label>
  </h2>
  <div class="content">
    <a href="/media/images/signal_divider_doubled_division_parallel_code.jpg" target="_blank">
      <img style="height: 100%" src="/media/images/signal_divider_doubled_division_parallel_code.jpg" />
    </a>
  </div>
</section>
<section>
  <a href="/media/files/61212.fast.txt" target="_blank">code file</a>
</section>
#+END_EXPORT
